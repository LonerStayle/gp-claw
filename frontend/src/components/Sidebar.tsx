    ...
    <aside className="flex w-64 flex-col border-r border-border bg-secondary">
      ...
      <div className="p-3">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground transition-colors hover:bg-accent"
        >
